...
control 'trusted-certificate-default-01' do
  impact 1.0
  title 'The inline certificate is installed'
...
control 'trusted-certificate-default-02' do
  impact 1.0
  title 'The removed certificate is absent'
